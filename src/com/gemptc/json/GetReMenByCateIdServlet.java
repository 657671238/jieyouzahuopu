 ...
 */
@WebServlet("/getReMenByCateId")
public class GetReMenByCateIdServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetReMenByCateIdServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(cate_id!=null&&!cate_id.trim().equals("")) {
			...
			try {
				ArrayList<Product> arrayList = dao.getReMenByCateId(cate_id,start,length);
